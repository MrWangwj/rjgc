...
return [
    ...
    'header' => [
        ...
        'xinke' => [
            ...
            'course' => [
                'Host' => '59.69.173.117',
                'Referer' => 'http://59.69.173.117/jwweb/wsxk/stu_zxjg.aspx',
    ...
    'formdata' => [
        ...
        'xinke' => [
            'login' => [
                ...
                'cCode'=> '',
                'PassWord'=> '',
                'pcInfo'=> 'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; WOW64; Trident/7.0; .NET4.0C; .NET4.0E; .NET CLR 2.0.50727; .NET CLR 3.0.30729; .NET CLR 3.5.30729)x860 SN:NULL',
                'Sel_Type'=> 'STU',
