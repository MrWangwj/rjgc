    ...
    <div class="weui-cells weui-cells_form">
        <div class="weui-cell">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" type="number" placeholder="请输入学号"  id="user_id">
            </div>
        ...
        <div class="weui-cell weui-cell_vcode">
            ...
            <div class="weui-cell__ft">
                <img class="weui-vcode-img" src="/user/course/edu/login/validate/0" onclick="changeValidateCode()" id="validateImg">
            </div>
        </div>
    </div>
...
@section('js')
    <script src="/user/js/course/md5.js"></script>

    <script>
        function changeValidateCode(){
            var Obj = $('#validateImg');
            var dt = new Date();
            var src = "/user/course/edu/login/validate/"+dt.getMilliseconds();
            Obj.attr('src', src);
        }
                ...
                function (data) {
                    ...
                    if(parseInt(data.code) === 0){
                        ...
                        $.toast(data.msg, function () {
                            window.location = '/user/course/input/course';
                        });
                    }
                }
            )
